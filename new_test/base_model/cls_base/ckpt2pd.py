...
def optimize_class_model(args, logger=None):
    ...
    try:
        ...
        if not args['num_labels']:
            _, label2id, id2label = init_predict_var(args['model_dir'])
        # ---
...
if __name__ == '__main__':
    ...
    # parser.add_argument('-bert_model_dir', type=str, default=BERT_BASE_DIR,
    ...
    # parser.add_argument('-max_seq_len', type=int, default=56,
    #                     help='maximum length of a sequence,default:56')
