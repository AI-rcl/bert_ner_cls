...
class Model(object):
    def __init__(self, config):
        ...
        # add placeholders for the model_data
        ...
        # loss of the model_data
        self.loss = self.loss_layer(self.logits, self.lengths)

        # bert模型参数初始化的地方
        init_checkpoint = dir_path+"/chinese_L-12_H-768_A-12/bert_model.ckpt"
        # 获取模型中所有的训练参数。
        ...
        # saver of the model_data
        self.saver = tf.train.Saver(tf.global_variables(), max_to_keep=5)

    def bert_embedding(self):
        # load bert embedding
        bert_config = modeling.BertConfig.from_json_file(dir_path+"/chinese_L-12_H-768_A-12/bert_config.json")  # 配置文件地址。
    ...
    def create_feed_dict(self, is_train, batch):
        ...
        :param batch: list train/evaluate ner001
        :return: structured ner001 to feed
        """
    ...
    def run_step(self, sess, is_train, batch):
        ...
        :param batch: a dict containing batch ner001
        :return: batch model_data, loss of the batch or logits
        """
    ...
    def evaluate(self, sess, data_manager, id_to_tag):
        """
        :param sess: session  to run the model_data
        :param ner001: list of ner001
        :param id_to_tag: index to tag name
        :return: evaluate model_data
        """
        results = []
